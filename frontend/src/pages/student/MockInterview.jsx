...
const AI_MOCK_INTERVIEW_URL = 'https://ai-mock-interview-latest.onrender.com/'
...
export default function MockInterview() {
  ...
  const start = async () => {
    ...
    const res = await api.get(
      `/interviews/questions/?role=${encodeURIComponent(role)}&difficulty=${difficulty}`
    )
    ...
    return (
      <div className="max-w-xl mx-auto card p-8 text-center">
        ...
        <p className="text-slate-500 text-sm mb-6">
          Practice with realistic role-specific questions. Your answers are
          evaluated using a transparent rule-based scoring model.
        </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-600 mt-1">
                Practice with an AI-powered mock interview experience.
              </p>

              <a
                href={AI_MOCK_INTERVIEW_URL}
                target="_blank"
